document.addEventListener("DOMContentLoaded", e => {
    ...
    document.querySelector("#cboTipos").addEventListener("change", function(){
        ...
        var AlmacenamientoValor = ["megabyte", "bit", "byte", "kilobyte", "terabyte", "gigabyte"];
        var AlmacenamientoText = ["Megabyte", "Bit", "Byte", "Kilobyte", "Terabyte", "Gigabyte"];
    ...
    form.addEventListener("submit",event => {
        ...
        switch (Convertir){
            ...
            case "Longitud":
                ...
                Convertidor = { "megabyte":1, "bit":8.388608, "byte":1.048576, "kilobyte":1.024, "terabyte":0.00000095367431660625, "gigabyte":0.0009765625};
        ...
        $res.innerHTML = `Respuesta: ` + (Convertidor[a]/Convertidor[de]*cantidad).toFixed();
